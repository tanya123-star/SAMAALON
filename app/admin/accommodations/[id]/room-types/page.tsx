  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-xl font-bold">
        Room Types: {acc.name} ({acc.beach.name})
      </h1>
      <form
      ...
      <div className="mt-6 space-y-2">
        {roomTypes.map((r) => (
          ...
          >
            ...
            <div className="flex gap-1">
              <Link
                href={`/admin/accommodations/${accommodationId}/room-types/${r.id}/edit`}
        ...
        {roomTypes.length === 0 ? (
          <p className="text-muted-foreground text-sm">No room types yet.</p>
        ) : null}
      </div>
    </div>
  )
