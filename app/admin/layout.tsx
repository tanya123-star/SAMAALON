    ...
    <div className="flex min-h-screen bg-[#FAF8F5]">
      ...
      <aside className="w-64 bg-[#1C2A28] text-white flex flex-col justify-between p-6 hidden md:flex">
        ...
        <div className="pt-6 border-t border-white/10 text-[11px] text-white/60">
          <Link href="/" className="text-white hover:underline block mb-2">← Back to Main Site</Link>
      ...
      <div className="flex-1 flex flex-col">
        {/* Mobile Header Bar */}
        <header className="md:hidden bg-[#1C2A28] text-white p-4 flex items-center justify-between">
